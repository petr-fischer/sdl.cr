...
loop do
  ...
  rect = SDL::Rect[(cx + width/4 - 51).to_i, (cy + height/4 - 51).to_i, 102, 102]
  ...
  renderer.draw_color = GREEN
  12.times do |i|
    x1 = rand(50..cx.to_i - 100)
	y1 = rand(cy.to_i + 50..height - 50)
	x2 = rand(50..cx.to_i - 100)
	y2 = rand(cy.to_i + 50..height - 50)
